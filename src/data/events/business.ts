...
export const businessEvents: GameEvent[] = [
  ...
  },
  {
    ...
    artistVariants: {
      ...
      socialite: {
        description: '某档主打"贵公子生活"的观察类综艺来邀请南陌做常驻——展示"真实富贵生活"的概念。听起来是南陌人设的完美舞台，但这类综艺最大的风险是"真实生活和人设不一致"会被 24 小时镜头放大。制片主任说:"我们剪辑不卖惨不捧杀，真实就是话题。" 南陌听到"真实"两个字，脸上一闪不安。',
      },
    },
    choices: [
      {
  ...
  },
  {
    ...
    artistVariants: {
      ...
      socialite: {
        description: '某高奢电商平台邀请南陌做"贵公子私藏好物"专场——卖的是高单价精品，单场坑位费 150 万。这是高端带货，但"南陌带货"四个字一旦传出去，他贵公子的人设会不会塌？平台商务的原话是:"我们包装成生活分享，不是带货。"——但内娱所有人都看得懂。',
      },
    },
    choices: [
      {
