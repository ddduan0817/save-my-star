...
export const phoneCallEvents: GameEvent[] = [
  ...
  // 7. 综艺导演来电
  {
    ...
    artistVariants: {
      idol: {
        description: '“喂？是甄帅的经纪人吗？我是《浪哥》的导演。”你差点没拿稳手机。这节目你们做梦都想上。“有个嘉宾临时退了，明天开录。你们来不来？，现在就要答复我。”',
      },
      singer: {
        description: '“喂？是高八度的经纪人吗？我是《我们的歌》的导演。”你差点没拿稳手机。八哥念叨这个节目念叨了一年了。“有个嘉宾临时退了，明天开录。你们来不来？，现在就要答复我。”',
      },
      actor: {
        description: '“喂？是郝美丽的经纪人吗？我是《无限超越班》的导演。”你差点没拿稳手机。这节目对演员来说是一次大型“演技再认证”。“有个嘉宾临时退了，明天开录。你们来不来？，现在就要答复我。”',
      },
      influencer: {
        description: '“喂？是冷冰凝的经纪人吗？我是《五十公里桃花坞》的导演。”你差点没拿稳手机。带货主播能上S级综艺，是转型最稳的一条路。“有个嘉宾临时退了，明天开录。你们来不来？，现在就要答复我。”',
      },
      socialite: {
        description: '“喂？是南陌格的经纪人吗？我是《演员请就位》的导演。”你差点没拿稳手机，这节目对花瓶小生来说是最凶险也最能翻身的舞台。“有个嘉宾临时退了，明天开录。你们来不来？，现在就要答复我。”',
      },
    },
    isPhoneCall: true,
    phoneCallMeta: {
