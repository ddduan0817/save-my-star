...
export const lateGameEvents: GameEvent[] = [
    ...
    choices: [
      {
        ...
        outcome: {
          ...
          statChanges: { commercialValue: 9, fanLoyalty: 6, money: 110000 },
          conditionalOutcomes: [
            {
              condition: { minPrRisk: 60 },
              narration: '跨年表演的热度被之前积累的争议盖过了。弹幕里一半人在刷"换人""不配"。本该是高光时刻，却变成了争议焦点。',
              statChanges: { commercialValue: 3, fanLoyalty: -3, money: 110000, prRisk: 6 },
            },
          ],
        },
      },
      {
        ...
        outcome: {
          ...
          statChanges: { commercialValue: 5, money: 140000 },
        },
      },
    ],
  },
    ...
    choices: [
      ...
      },
      {
        ...
        outcome: {
          ...
          statChanges: { prRisk: 9, fanLoyalty: 3, commercialValue: -5 },
        },
      },
    ],
  },
    ...
    choices: [
      {
        ...
        outcome: {
          ...
          statChanges: { commercialValue: 9, money: 210000, fanLoyalty: -3 },
        },
      },
      {
        id: 'decline_bigwig',
      ...
      },
      {
        ...
        outcome: {
          ...
          statChanges: { commercialValue: 7, money: 140000, fanLoyalty: 3 },
        },
      },
    ],
  },
    ...
    choices: [
      {
        ...
        outcome: {
          ...
          statChanges: { prRisk: -6, money: -40000, fanLoyalty: 3 },
        },
      },
      {
        id: 'report_and_sue',
    ...
    choices: [
      {
        ...
        outcome: {
          ...
          statChanges: { money: 350000, commercialValue: -12, fanLoyalty: -6 },
          unlockTag: 'retired',
        },
      },
      {
        ...
        outcome: {
          ...
          statChanges: { fanLoyalty: 12, commercialValue: 6, prRisk: -3 },
        },
      },
    ],
  },
  {
    ...
    severity: 'medium',
    title: '万人演唱会/粉丝见面会',
    description: '场馆已经订好了，一场万人规模的演唱会（或粉丝见面会）正在筹备。这将是今年最后的大型活动，成功了是完美收官，失败了就是年度笑话。',
    emoji: '🎪',
    minDay: 25,
    ...
    choices: [
      {
        ...
        outcome: {
          narration: '当晚的舞台效果让所有人震撼。三个小时的演出，返场了两次，粉丝们哭着不肯走。"年度最佳演唱会"的美誉名至实归。',
          statChanges: { money: -110000, fanLoyalty: 12, commercialValue: 9, prRisk: -6 },
        },
      },
      {
        id: 'standard_show',
        ...
        outcome: {
          ...
          statChanges: { money: -40000, fanLoyalty: 6, commercialValue: 3 },
        },
      },
    ],
  },
