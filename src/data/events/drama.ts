...
export const dramaEvents: GameEvent[] = [
  ...
  },
  {
    ...
    artistVariants: {
      ...
      socialite: {
        description: '南陌和古偶剧里的女主被磕 CP 磕得全网都在截屏——戏外互动的甜度比戏里还高。"南陌某某 现实版贵公子CP" 挂在热搜榜中部不肯下。但南陌唯粉怕的是"贵公子只能磕我们自己"，那位女主的粉丝怕的是"我姐姐被拉低咖位"——两边谁都不干。',
      },
    },
    choices: [
      {
  ...
  },
  {
    ...
    artistVariants: {
      ...
      socialite: {
        description: '时尚芭莎年度盛典的座位表流出——南陌从去年的前排，滑到了今年的第三排偏角。#南陌 时尚芭莎 座位# 冲到第 12。圈内一眼就能看懂:"是南陌那边资源线出了问题"。三个合作的高奢品牌的市场负责人都在观望你怎么处理。',
      },
    },
    choices: [
      {
