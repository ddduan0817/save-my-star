...
export const crisisEvents: GameEvent[] = [
  {
    ...
    artistVariants: {
      ...
      socialite: {
        description: '代拍放了组清晰的大图——南陌格和某位圈内富二代千金一起从某酒店出来，两人合拍的当季新款手表、包款被扒出来刚好是情侣系列。#南陌格 某某某# 冲到热搜第 7。粉丝超话里的声音很微妙："门当户对我磕我磕"和"贵公子不能塌"各占一半。高奢品牌方反倒松了一口气——他们最怕你谈的是网红，谈同圈富二代反而"符合品牌调性"。',
      },
    },
    choices: [
      {
  ...
  },
  {
    ...
    artistVariants: {
      ...
      socialite: {
        description: '某私密群截图流出——南陌格出道前在某个"圈内饭局群"里说过几句对女嘉宾的轻浮评价，时间是 2021 年。#南陌格 油腻男# 挂上热搜第 5。这次连贵公子粉丝都不太敢洗，"贵公子人设"和"群里说骚话"完全反着来。一个高奢女装品牌已经在内部发起"代言人重新评估"流程。',
      },
    },
    choices: [
      {
  ...
  },
  {
    ...
    artistVariants: {
      ...
      socialite: {
        description: '酒会后的代拍图——南陌格站在某 club 外面抽雪茄，旁边几个圈内贵公子陪同。#南陌格 抽雪茄# 上了热搜第 6。粉丝两极分化，"贵公子就该有这样调调"和"塌人设了"五五开。但高奢品牌方反而觉得这场景"和品牌调性不冲突"——他们上一组大片就是雪茄馆背景。',
      },
    },
    choices: [
      {
  ...
  },
  {
    ...
    artistVariants: {
      ...
      socialite: {
        description: '某 high-end 会所内部流出——南陌格喝多，拿着酒杯模仿京圈某老牌阔太太"姐姐我这杯敬您"的客套腔，还补了一句"她们就爱年轻人陪"。圈子很小，被模仿的那位第二天就在朋友圈冷笑："这孩子酒量不行话也不行。"热搜挂到第 12 位就被撤了，但该阔太太资源圈的门基本关上了。',
      },
    },
    choices: [
      {
  ...
  },
  {
    ...
    artistVariants: {
      ...
      socialite: {
        description: '一个自称是某富二代千金的女生，伪造邀请函混进了南陌格出席的私人晚宴现场。当晚被场地保安请出去时，她身上穿的是和南陌格当天造型同色系的礼服。这事圈子里很快传开了，"南陌格身边还能混进这种人"的私下议论开始影响他在圈内顶级局的入场资格。',
      },
    },
    choices: [
      {
