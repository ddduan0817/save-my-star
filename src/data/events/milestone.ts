...
export const milestoneEvents: GameEvent[] = [
  // ===== 高商业价值触发 =====
  {
    ...
    emoji: '💎',
    statConditions: { minCommercial: 80 },
    minDay: 8,
    choices: [
      {
        id: 'auction_brands',
        ...
        outcome: {
          ...
          statChanges: { money: 200000, commercialValue: -5, prRisk: 3 },
        },
      },
      {
        id: 'bundle_deal',
  ...
  },
  {
    ...
    emoji: '📈',
    statConditions: { minCommercial: 85 },
    minDay: 12,
    choices: [
      {
        id: 'sign_bet',
        ...
        outcome: {
          ...
          statChanges: { money: 300000, prRisk: 5 },
  ...
  // ===== 高粉丝忠诚度触发 =====
  {
    ...
    emoji: '😤',
    statConditions: { minFanLoyalty: 85 },
    minDay: 8,
    choices: [
      {
        id: 'rein_in_fans',
        ...
        outcome: {
          ...
          statChanges: { fanLoyalty: -8, prRisk: -5, commercialValue: 3 },
        },
      },
      {
        id: 'turn_blind_eye',
  ...
  },
  {
    ...
    emoji: '💔',
    statConditions: { minFanLoyalty: 80 },
    minDay: 12,
    choices: [
      {
        id: 'unify_message',
      ...
      },
      {
        ...
        outcome: {
          ...
          statChanges: { prRisk: 8, commercialValue: -3, fanLoyalty: -3 },
        },
      },
    ],
  },
    ...
    choices: [
      {
        ...
        outcome: {
          ...
          statChanges: { money: 80000, commercialValue: -5, prRisk: 3 },
        },
      },
      {
        id: 'borrow_money',
    ...
    choices: [
      {
        ...
        outcome: {
          ...
          statChanges: { money: 150000, commercialValue: -5 },
        },
      },
      {
    ...
    choices: [
      {
        ...
        outcome: {
          ...
          statChanges: { prRisk: -15, commercialValue: -8, money: -50000 },
        },
      },
      {
        id: 'low_profile',
        ...
        outcome: {
          ...
          statChanges: { prRisk: -10, commercialValue: -5, fanLoyalty: -5 },
        },
      },
    ],
  },
