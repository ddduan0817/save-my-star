...
const WEIBO_POST_IMAGES: Partial<Record<ArtistArchetype, Record<string, string>>> = {
  ...
  actor: {
    work_photo: './weibo/actor/work_photo.jpg',
    selfie: './weibo/actor/selfie.jpg',
    work_promotion: './weibo/actor/work_promotion.jpg',
  ...
  socialite: {
    ...
    work_promotion: './weibo/socialite/work_promotion.jpg',
    fan_gift: './weibo/socialite/fan_gift.jpg',
    romance_hint: './weibo/socialite/romance_hint.jpg',
  },
};
