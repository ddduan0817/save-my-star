...
export const weiboPostTemplates: ArtistWeiboPostTemplate[] = [
  {
    ...
    artistPostVariants: {
      ...
      influencer: [
        '我在直播间和拍摄棚来回切换了一整天，成片还没出，先交几张工作花絮。',
        '今天从选品到拍摄再到收工，每个细节我都亲自过了一遍，认真营业的证据在这里。',
      ],
      socialite: [
  ...
  },
  {
    ...
    artistPostVariants: {
      ...
      influencer: [
        '我刚复盘完今晚的直播，哪些话没讲清、哪些产品还要再查，我都记下了。',
        '镜头关掉以后我也会累，也会怀疑自己。今晚先睡一觉，明天继续把事情做好。',
      ],
      socialite: [
  ...
  },
  {
    ...
    artistPostVariants: {
      ...
      influencer: [
        '我筹备很久的新系列今天上线，从选题到拍摄都亲自盯了，希望这次内容对你们真的有用。',
        '我把本周直播清单和实测过程都整理好了，今晚不只讲结果，也会把筛选标准讲明白。',
      ],
      socialite: [
  ...
  },
  {
    ...
    artistPostVariants: {
      ...
      influencer: [
        '我收到了你们做的留言册和手作，镜头外的我也被好好记住了，这份心意真的很重。',
        '我把大家寄来的信都拆完了。比起买很多东西，我更希望你们把生活过好，再来直播间聊天。',
      ],
      socialite: [
  ...
  },
  {
    ...
    artistPostVariants: {
      ...
      influencer: [
        '我会用直播间帮助这个助农项目讲清产品和产地，不收佣金，也公开每一笔去向。',
  ...
  },
  {
    ...
    artistPostVariants: {
      ...
      influencer: [
        '我今天没开重滤镜，换了自然光试试。镜头前后都是真实的我。',
        '我刚拍完今天的内容，妆还在线，顺手交一张高清自拍给你们。',
      ],
      socialite: [
  ...
  },
  {
    ...
    artistPostVariants: {
      ...
      influencer: [
        '我今天不分享链接，只想分享一点藏不住的好心情。',
        '我最近状态很好，原因暂时不公开。懂的都懂。',
      ],
      socialite: [
